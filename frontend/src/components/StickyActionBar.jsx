...
export default function StickyActionBar() {
  const site = useSite();
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-lg border-t border-[#f4e4c6] py-3 px-4 shadow-[0_-10px_30px_rgba(0,0,0,0.06)]" data-testid="sticky-action-bar">
